...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { address: @trainer.address, client_id: @trainer.client_id, current_weight: @trainer.current_weight, email_add: @trainer.email_add, gender: @trainer.gender, height: @trainer.height, name: @trainer.name } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { address: @trainer.address, client_id: @trainer.client_id, current_weight: @trainer.current_weight, email_add: @trainer.email_add, gender: @trainer.gender, height: @trainer.height, name: @trainer.name } }
